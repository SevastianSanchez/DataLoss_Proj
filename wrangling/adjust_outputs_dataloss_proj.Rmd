...
merged_full <- read_csv("data/output/merged_df.csv") #load from directory
...
# full dataframe saved to directory (checked for missing identifiers)
write_csv(merged_full, file = 'data/output/merged_full.csv')
```
...
```{r}
merged_full <- read_csv("data/output/merged_full.csv")
